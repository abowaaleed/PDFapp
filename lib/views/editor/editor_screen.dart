...
import '../merge/text_editor_screen.dart';
import '../merge/export_settings_screen.dart';
...
class EditorScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('إضافة نصوص على الصور'),
        actions: [
          IconButton(
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  const Text('اختر صوراً لإضافة نصوص عليها',
          ...
          return Column(
            children: [
              Padding(
                ...
                child: Text(
                  'اضغط على أيقونة التحرير لإضافة نصوص على الصورة',
